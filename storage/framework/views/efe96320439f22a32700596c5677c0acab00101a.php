<?php $__env->startSection('content'); ?>
 <div class="col-xs-12 omola">
                ...
                <p><?php echo $commissionData->commission; ?></p>
                <!-- <h3>ملاحظات:</h3>
                <ul>
                ...
                <p><big>حساب قيمة العمولة:</big> إذا تم بيع السلعة بسعر
                    <input type="number" name="price" id="price" onkeyup="document.getElementById('output').innerHTML = this.value * <?php echo e($commissionData->commission_count /100); ?>" /> ريال فأن العمولة هي: <span id="output"></span> ريال</p>
                <?php endif; ?>
                <h2>دفع العموله</h2>
                ...
                <h5><?php echo e($bank->bank_name); ?></h5>
                <h6><?php echo e($bank->account_owner); ?></h6>
                <h6><big>رقم الحساب</big> <?php echo e($bank->account_number); ?> </h6>
                <h6><big>الايبان</big> <?php echo e($bank->international_account); ?> </h6>
                <input onclick="this.value='تم الإرسال لجوالك المسجل وهو:<?php echo e(Auth::user()->phone); ?>'" type="button" value="إرسال رقم الحساب لجوالك sms" id="myButton1" />
                <hr>
                ...
                <form action="<?php echo e(route('do-add-transfer')); ?>" method="POST" role="form">
