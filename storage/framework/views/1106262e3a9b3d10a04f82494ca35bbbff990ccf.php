<?php $__env->startSection('title'); ?>
    ...
    <?php echo e(trans('admin.countryEdit')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-12">
        ...
        <form action="<?php echo e(route('country-do-edit', ['id' => $data->id])); ?>" method="post">

            <div class="panel panel-flat">

                <div class="panel-heading">

                    <h5 class="panel-title"> <?php echo e(trans('admin.countryEdit')); ?> </h5>
