    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-top-header" action="<?php echo e(route('register')); ?>" method="post" enctype="multipart/form-data">
...
<div id="myModal1" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-top-header" action="<?php echo e(route('login')); ?>" method="post">
                    <div class="user-name">
                        <label> البريد الإلكتروني</label>
                        <br />
                    ...
                    <div class="chekbox">
                        ...
                        <a href="<?php echo e(url('/login-user-forget')); ?>">هل نسيت كلمة المرور</a>
                    </div>
                    <div class="submin-in">
