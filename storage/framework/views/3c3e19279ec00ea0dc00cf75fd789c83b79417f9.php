<?php $__env->startSection('title'); ?>
    <?php echo trans('admin.modelDet') . ' ' . $data->name; ?>
...
<?php $__env->startSection('pageName'); ?>
      <?php echo trans('admin.modelDet')  . ' : <span class="text-success">' . $data->name . '</span>'; ?>
                    ...
                    <fieldset>
                        ...
                        <div class="collapse in" id="demo1">
                            ...
                            <div class="form-group">
                                ...
                                <input readonly type="text" value="<?php echo e($mark->name); ?>"  class="form-control"
