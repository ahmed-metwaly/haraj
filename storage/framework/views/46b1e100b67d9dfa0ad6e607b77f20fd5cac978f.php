        ...
        <?php if(count($data) > 0): ?>
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo e(route('city-details', ['id' => $value->id])); ?>"><?php echo e($value->name); ?></a></td>
                    <td><a href="<?php echo e(route('country-details', ['id' => $value->country_id])); ?>"><?php echo e($value->country_name); ?></a></td>
                    <td><a href="<?php echo e(route('admin-details', ['id' => $value->user_id ])); ?>"> <?php echo e($value->username); ?> </a> </td>
                    <td><?php echo e($value->created_at); ?></td>
                    <td><a href="<?php echo e(route('city-details', ['id' => $value->id])); ?>"><i class="icon-tv"
                                                                                        aria-hidden="true"></i></a></td>
                    <td><a href="<?php echo e(route('city-edit', ['id' => $value->id])); ?>"><i class="icon-pencil"
                                                                                     aria-hidden="true"></i></a></td>
                    <td><a class="do-delete" href="<?php echo e(route('city-delete', ['id' => $value->id])); ?>"><i
