<?php $__env->startSection('title'); ?>
    ...
    <?php echo trans('admin.countryDet') . ' ' . $data->name; ?>
...
<?php $__env->startSection('sectionName'); ?>
    ...
    <a href="<?php echo e(route('countries')); ?>"> <?php echo e(trans('admin.sideCountriesTitle')); ?> </a>
...
<?php $__env->startSection('pageName'); ?>
      ...
      <?php echo trans('admin.countryDet')  . ' : <span class="text-success">' . $data->name . '</span>'; ?>
        ...
        <form action="#" method="post">
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-heading">
                    ...
                    <h5 class="panel-title"> <?php echo e(trans('admin.countryData')); ?> </h5>
                    ...
                    <fieldset>
                        ...
                        <div class="collapse in" id="demo1">
                            ...
                            <div class="form-group">
                                ...
                                <label> <?php echo e(trans('admin.countryName')); ?> </label>

                                <input readonly type="text" value="<?php echo e($data->name); ?>"  class="form-control"

                                       placeholder=" <?php echo e(trans('admin.countryName')); ?> ">
